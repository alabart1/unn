...
app.engine(
  ".hbs",
  exphbs({
    defaultLayout: "main", //plantillas .hbs ()
...
app.use(
  session({
    //almacenar temporalmente las authrnticasiones sesiones
    secret: "tmoainavi",
    resave: true,
...
parser.on("open", function() {
  console.log("placaSerialCom10Conectada");
});
var datotemp;
var data1;
...
board.on("ready", function() {
  ...
  io.on("connection", function(socket) {
    ...
    socket.on("ventilador", function(estadovt) {
